...
class CourseLibrary extends Component{
    ...
    render() {
        return (
            <ul>
                {this.renderCourse({title: 'Up and Running with Redis', description: 'In this course you will learn how to work with the efficient Redis database to manage key value relationships.'})}
